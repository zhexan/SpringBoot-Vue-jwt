    ...
    <el-container style="height: 100%" v-if="!loading">
      <el-header class="main-content-header">
        ...
        <div style="flex: 1;padding: 0 20px;text-align: center">
          <el-input vl-model="seachinput.text" style="width: 100%; max-width: 500px" placeholder="搜索论坛相关内容...">
            <template #prefix>
              <el-icon>
                <Search/>
              </el-icon>
          ...
          <el-scrollbar style="min-height: calc(100vh - 55px)">
            <el-menu
              ...
              <el-sub-menu index="3">
                ...
                <el-menu-item index="/index/privacy-settings">
                  <template #title>
                    <el-icon>
                      <Lock/>
                    </el-icon>
